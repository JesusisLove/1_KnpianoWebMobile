                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text('删除确认', style: TextStyle(color: widget.knFontColor, fontSize: 17, fontWeight: FontWeight.bold)),
                                      ],
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text('确定要删除【${subjectEda.subjectSubName}】这个级别吗？'),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text('删除失败', style: TextStyle(color: widget.knFontColor, fontSize: 17, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      Padding(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.error_outline, color: widget.knFontColor, size: 22),
                        const SizedBox(width: 8),
                        Text('网络异常', style: TextStyle(color: widget.knFontColor, fontSize: 17, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                  Padding(
